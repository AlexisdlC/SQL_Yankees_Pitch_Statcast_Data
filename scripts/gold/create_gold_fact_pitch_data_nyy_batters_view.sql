...
from the POV of Yankees batters
=================================================================================
*/

IF OBJECT_ID('gold.fact_pitch_data_nyy_batters', 'V') IS NOT NULL
	DROP VIEW  gold.fact_pitch_data_nyy_batters
GO

CREATE VIEW gold.fact_pitch_data_nyy_batters AS
...
CTE_enhanced_nyy_pitch_data AS (
	...
	FROM silver.pitch_data_filtered_batters AS pd
	...
	CASE
		WHEN g.away_team_id = 147 THEN 'Top'
		ELSE 'Bot'
	END
)
